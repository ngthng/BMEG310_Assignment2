...
---
title: "Assignment2"
author: "Theo Nguyen-609857514, Jingxuan Chen-85741635, Hannah Yeung-"
date: "2023-10-12"
output:
...
```{r}
pca_test_result <-  prcomp(test_datasubset, center = TRUE, scale. = TRUE)

top5PC_data_test <-  as.data.frame(pca_test_result$x[, 1:5])
